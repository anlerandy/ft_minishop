...
require $_SERVER["DOCUMENT_ROOT"] . "/includes/admin/show_bask.php";
...
?>
	<div id="wrap">
		<div id="sidebar">
			...
			<a href="/includes/admin?p=bask">Paniers -></a><br/>
		</div>
		<div id="frame">
<?php

// Show les différentes pages admin.
if (isset($_GET['p']) || isset($_GET['categorie']) || isset($_GET['produit']) || isset($_GET['user']))
{
	...
	if (isset($_GET['p']) && $_GET['p'] === 'bask')
	{
		echo "<div  id=\"container\"><h2>Liste des paniers :</h2>";
		show_bask();
	}
